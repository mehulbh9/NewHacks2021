class Course:
    ...
    def __str__(self) -> str:
        ...
        for assignment in self.assignments: 
            ...
            string += str(name) + ": due " + str(assignment.duedate.strftime("%a")) + ", " + str(assignment.duedate.strftime("%B")) + " " + str(assignment.duedate.strftime("%d")) + ", " + str(assignment.duedate.strftime("%Y")) + " and completion time : " + str(assignment.time) + "\n"
