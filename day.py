class Day:
    ...
    def __str__(self) -> str:
        string = self.name.ljust(9) + ": has " + str(len(self.assignments)) + " assignments planned, with " + str(getTimeInHours(self.timeWork)) + " minutes of work and " + str(getTimeInHours(self.timeFree)) + " minutes free."
